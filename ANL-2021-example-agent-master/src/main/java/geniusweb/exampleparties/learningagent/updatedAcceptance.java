...
public class updatedAcceptance extends DefaultParty { // TODO: change name
    ...
    public updatedAcceptance() { // TODO: change name
    }

    public updatedAcceptance(Reporter reporter) { // TODO: change name
...
//                        }
    ...
    private void processAction(Action action) {
        if (action instanceof Offer) {
            ...
            // negotiation data.
            this.opponentModel.updateFrequency(((Offer) action).getBid());
//            System.out.println(this.opponentModel.frequencyOfBids);
...
//                System.out.println("Concession time !!!!!!!!!!!!!!!! : " + this.opponentExpectedConsseionTime);
            ...
            System.out.println("Expected utility of opponent" + this.opponentModel.calculateDesirability(lastReceivedBid));
            System.out.println("------------------");
...
//              System.out.println("The difference between bit" + this.difference);
    ...
    private void processAgreements(Agreements agreements) {
        ...
        if (!agreements.getMap().isEmpty()) {
            ...
            // this.negodata.add utility for opponent
    ...
    {
        bidlist.sort((b1,b2) -> utilitySpace.isPreferredOrEqual(b1,b2) ? 1 : 0);
    }
...
//                    getReporter().log(Level.INFO, "added to the offerablebids list with the utility value of: " +
//                            bidUtility + " where min range is : " + rangeMin + "and current time is: " + currentTime);
...
//                getReporter().log(Level.INFO, "Offerablebids size == 0");
        ...
        List<Bid> sorted = new LinkedList<Bid>();
