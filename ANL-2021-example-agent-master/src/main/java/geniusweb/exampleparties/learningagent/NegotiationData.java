...
public class NegotiationData {
   ...
   public HashMap<Double,Double> diffTime = new HashMap<>();
    ...
    public void addDifferenceTime(double time , double difference){
        diffTime.put(time,difference);

    }

    public HashMap<Double,Double> getDiffTime(){
